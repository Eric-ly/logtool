...
#class tail-thread(threading.Thread):
...
class Root(object):
	...
	def tail(self, logfile, **kw):
		pidnow = cherrypy.session.get('pid')
		f=open('out.txt','w')
		print >> f,pidnow
		f.close()
		#pidold = pidnow
		if pidnow != None :
			...
			#self.tail(self)
		#f=open('out.txt','w')
		#print >> f,path_conf.pidold
		#f.close()		
		#path_conf.pidold = pidold
		#f=open('out.txt','w')
		#print >> f,path_conf.pidold
		#f.close()
